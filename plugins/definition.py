...
class definition(Plugin):
    ...
    @register("en-US", "(define|definition of|definition) (.*)")
    def define(self, speech, language, regMatched):
        ...
        if language == 'fr-FR':
            ...
            self.say(u"Searching for "+query+" in the dictionary...")
        ...
        if definition != None:
            ...
            if language == 'fr-FR':
                ...
                self.say(u"Sorry, I could not find "+query+" in the dictionary...")

...
class alarmPlugin(Plugin):
    ...
    localizations = {
        'Alarm': {
            "settingAlarm": {
                "en-US": u"Setting the Alarm\u2026", "fr-FR": u"Programmation de l'alarme."
            }, "alarmWasSet": {
                "en-US": "Your alarm is set for {0}:{1} {2}.", "fr-FR": "Votre alarme est programmée pour {0}h{1}."
            }, "alarmSetWithLabel": {
                "en-US": "Your alarm {0} {1} is set for {2}:{3} {4}.", "fr-FR": u"Votre alarme {0} {1} est programmée pour {2}h{3}."
            }
        }
    }

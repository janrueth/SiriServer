...
class smalltalk(Plugin):
    ...
    def st_hello(self, speech, language):
        if language == 'de-DE':
            self.say("Hi, was kann ich dir helfen?")
        else:
            self.say("Hello")
    ...
    def st_name(self, speech, language):
        if language == 'de-DE':
            self.say(u"Mein Name ist Siri, aber das weißt du ja bereits.")
        else:
            self.say("Siri.")
        self.complete_request()
    ...
    @register("de-DE", u".*erzähl.*Geschichte.*")
    ...
    def st_love_you(self, speech, language):
        if language == 'de-DE':
            self.say('All you need is Love. Und ein iPhone.','Oll jou need is Lov. Und ein iPhone.');         
        else:
